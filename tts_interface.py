...
def detect_arabic_emotions(text):
    emotions_dict = {
    "فرح": ["فرح", "سعيد", "مبسوط", "مبسوطة", "سرور", "ابتسامة", "مسرور", "حلو", "حلوة", "جيد", "تمام", "مبسوط جدًا", "فل", "على بعضه", "مبسوطة قوي", "كيوت"],
    "حزن": ["حزن", "زعل", "زعلان", "مكسور", "دموع", "حزين", "موجوع", "موت", "خسارة", "متضايق", "متكسّر", "خايف", "مش كويس", "موجوعة", "قلبه موجوع", "حالة يرثى لها"],
    "غضب": ["غضب", "زعلان", "انفجر", "غاضب", "تعبان", "نفسيتي تعبانة", "مضايق", "مجنن", "مزنوق", "مزعّل", "مش طايق", "طفشان", "معصّب", "قرفان"],
    "خوف": ["خوف", "قلق", "مرعوب", "مخيف", "خايف", "توتر", "قلقان", "متوتر", "مرتبك", "مش مطمئن", "مخنوق"],
    "تفاؤل": ["تفاؤل", "أمل", "نصر", "نجاح", "سعادة", "مستقبل", "حلم", "على قدها", "مبسوط بالأمل", "متحمس", "واعد", "فيه أمل", "ان شاء الله"],
    "دهشة": ["دهشة", "مندهش", "متفاجئ", "مستغرب", "يا نهار أبيض", "بجد؟", "مش مصدق", "عجيب", "مش متوقع"],
}
